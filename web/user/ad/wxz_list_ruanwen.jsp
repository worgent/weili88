...
<tr>
    ...
    <td>
        <a href="wxz_list.jsp#" onclick="detail('${item.id}');return false;">${item.title}</a>
    </td>
    <td>
        ${item.priceStr}
    </td>
    ...
    <td>
        <a href="wxz_list.jsp#" onclick="insert_load('${item.id}');return false;">接单</a>|<a href="/user/ad/preview_rw.do?id=${item.id}" target="_blank">预览</a>
    </td>
</tr>
</c:forEach>
