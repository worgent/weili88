            ...
            <div id="body" style="clear:left">
                <dl class="content">
					...
					<dd>
						...
						<input size="30" name="WIDseller_email" value="fastsdk@flashapp.cn" />
						<span>必填
</span>
					</dd>
					<dt>商户订单号：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDout_trade_no" value="1" />
					...
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDsubject" value="刘测试订单名称" />
						<span>必填
</span>
					</dd>
					<dt>付款金额：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="money" value="0.1" />
						<span>必填
</span>
					</dd>
					<dt>订单描述
：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDbody" value="订单描述" />
						<span></span>
					</dd>
					<dt>商品展示地址：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDshow_url" value="http://www.xiaoshuocity.com" />
