                ...
                <table class="wxtable" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;">
                            剩余积分:<br>￥${userGgz.leftJifen}微币
                        </td>
                        <td style="text-align: left;">
                            账户余额:<br>￥${userGgz.leftMoney}元
                        </td>
                        <td style="text-align: left;">
                            累计充值:<br>￥${userGgz.moneyInput}元
                        </td>
                        <td style="text-align: left;">
                            累计消费:<br>￥${userGgz.moneyOutput}元
                        </td>
                        <td style="text-align: left;">
                            等待支付:<br>￥${userGgz.moneyOutputLock}元
                        </td>
                        <td style="text-align: center;width:100px">
                            <a href="/user/chongzhi/order_insert_load.do" title="我要充值">
                            <button class="button orange medium">我要充值</button>
                            </a>
                        </td>
                    </tr>
                    </tbody>
                    ...
                    <a href="#" onclick="msg_detail('${item.id}',${empty item.readTime});return false;">
                        <c:choose>
                            <c:when test="${empty item.readTime}">
                                <b><c:out value="${fn:substring(item.title,0,30)}"/></b><img src="/img/weidu.jpg"/>
                            </c:when>
                            <c:otherwise>
