...
<tr>
    ...
    <td>
            <a href="#" onclick="detail_user('${item.user.id}');return false;">${item.user.englishName}</a>
    </td>
    <td>
        <a href="#" onclick="detail_ad('${item.id}');return false;">${item.title}</a>
    </td>
    <td>
        ${item.priceStr}
    </td>
...
<script type="text/javascript">
    ...
    function updateStauts(id, title,status) {
        ...
        layer.confirm("确认" + operate + "《" + title + "》吗？", function(index) {
            var url = "/gly/ad/ajax_status.do?id=" + id;
