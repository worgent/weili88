        ...
        <div id="MainBody" class="layout-full-width">
            ...
            <div id="CooperationMain" class="layout-main box clear-fix" style="height:520px;">
                <div class="layout-block-header">
                    <h2><a style="color: #333" href="price_min.jsp" title="">微信主支付最低值</a>
                    </h2>
                </div>
                    ...
                    <table class="formTable" width="60%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;padding-left:10px;    ">
                                <input type="text" name="minZhifu" id="minZhifu" size="30" value="${setting.minZhifu}"/>元
                            </td>
                        </tr>
        ...
        $("#b1").click(function(e) {
            ...
            jQuery.post(url, $("#f1").serialize(), function(jsonobj) {
                if (jsonobj.code == "200") {
                   ...
                   // window.location.href = "/gly/setting/update_load.do?type=${type}";
                } else {
                    flag = 1;
